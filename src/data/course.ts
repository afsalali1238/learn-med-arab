    ...
    "vocabTables": [
      {
        ...
        "rows": [
          ...
          [
            "Every 12 Hours",
            "كل 12 ساعة",
            "Kul ethnay asharah saa'ah"
          ],
          [
            "One Teaspoonful",
            "ملعقة شاي واحدة",
            "Melaqet shaay waahedah"
          ],
          [
            "One Tablespoonful",
            "ملعقة واحدة كبيرة",
            "Melaqah waahedah kabeerah"
          ],
          [
            "For Ten Days",
            "لمدة عشرة أيام",
            "Lemuddat ashrat ayyaam"
          ],
          [
            "For One Week",
            "لمدة أسبوع",
          ...
          [
            "Four Times Daily",
            "أربع مرات في اليوم",
            "Arba' marraat fee alyoom"
          ],
          [
            "Divided Doses",
            "مقسمة إلى عدة جرعات",
            "Muqassamah elaa eddat jura'aat"
          ],
          [
            "Gradually",
            "تدريجياً",
    ...
    "vocabTables": [
      {
        ...
        "rows": [
          ...
          [
            "Use in pregnancy",
            "يستخدم في حالة الحمل",
            "Yustkhdam fee haalat elhaml"
          ],
          [
            "Use in lactation",
            "في حالة الإرضاع",
